    ...
    class Grayscale : BaseAddinEffect
    {
        ...
        public override Image Apply( Image image )
        {
            ...
            switch ( grayscaleMode )
            {
                ...
                case GrayscaleMode.TawawaBlueN:
        ...
        internal void InitColorMatrix()
        {
            ...
            #endregion
            #region TawawaBlueN
            GrayscaleMatrix.Add( GrayscaleMode.TawawaBlueN, new ColorMatrix( new[]{
                new float[] { -0.25f,      0,      0, 0, 0},        // red scaling factor
                new float[] {      0, 0.650f,      0, 0, 0},        // green scaling factor
                new float[] {      0,      0, 0.350f, 0, 0},        // blue scaling factor
                new float[] {      0,      0,      0, 1, 0},        // alpha scaling factor
                new float[] { -0.500f, 0.100f, 0.330f, 0, 1}         // three translations
            } ) );
            #endregion
